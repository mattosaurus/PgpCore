...
namespace PgpCore.Tests
{
    public class UnitTestsAsync
    {
        ...
        public async Task GenerateKeyAsync_CreatePublicPrivateKeyFiles()
        {
            ...
            // Act
            await pgp.GenerateKeyAsync(publicKeyFilePath1, privateKeyFilePath1, password1);
        ...
        public async Task EncryptFileAsync_CreateEncryptedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAsync(contentFilePath, encryptedContentFilePath, publicKeyFilePath1);
        ...
        {
            // Arrange
            await ArrangeAsync(KeyType.Known);
            PGP pgp = new PGP();
        ...
        public async Task SignFileAsync_CreateSignedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.SignFileAsync(contentFilePath, signedContentFilePath, privateKeyFilePath1, password1);
        ...
        public async Task EncryptFileAsync_CreateEncryptedFileWithMultipleKeys(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAsync(contentFilePath, encryptedContentFilePath, keys);
        ...
        public async Task EncryptFileAndSignAsync_CreateEncryptedAndSignedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAndSignAsync(contentFilePath, encryptedContentFilePath, publicKeyFilePath1, privateKeyFilePath1, password1);
        ...
        public async Task EncryptFileAndSignAsync_CreateEncryptedAndSignedFileWithMultipleKeys(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAndSignAsync(contentFilePath, encryptedContentFilePath, keys, privateKeyFilePath1, password1);
        ...
        public async Task DecryptFileAsync_DecryptEncryptedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAsync(contentFilePath, encryptedContentFilePath, publicKeyFilePath1);
            await pgp.DecryptFileAsync(encryptedContentFilePath, decryptedContentFilePath1, privateKeyFilePath1, password1);
        ...
        //{
        //    // Arrange
        //    await ArrangeAsync(keyType, fileType);
        //    PGP pgp = new PGP();
        ...
        public async Task DecryptFileAsync_DecryptEncryptedFileWithMultipleKeys(KeyType keyType)
        {
            ...
            await pgp.EncryptFileAsync(contentFilePath, encryptedContentFilePath, keys);
            await pgp.DecryptFileAsync(encryptedContentFilePath, decryptedContentFilePath1, privateKeyFilePath1, password1);
            await pgp.DecryptFileAsync(encryptedContentFilePath, decryptedContentFilePath2, privateKeyFilePath2, password2);
            string decryptedContent1 = await File.ReadAllTextAsync(decryptedContentFilePath1);
            string decryptedContent2 = await File.ReadAllTextAsync(decryptedContentFilePath2);
        ...
        public async Task DecryptFileAndVerifyAsync_DecryptUnsignedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAsync(contentFilePath, encryptedContentFilePath, publicKeyFilePath2);
            var ex = await Assert.ThrowsAsync<PgpException>(async () => await pgp.DecryptFileAndVerifyAsync(encryptedContentFilePath,
        ...
        public async Task DecryptFileAndVerifyAsync_DecryptSignedAndEncryptedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.EncryptFileAndSignAsync(contentFilePath, encryptedContentFilePath, publicKeyFilePath1, privateKeyFilePath1, password1);
            await pgp.DecryptFileAndVerifyAsync(encryptedContentFilePath, decryptedContentFilePath1, publicKeyFilePath1, privateKeyFilePath1, password1);
            string decryptedContent = await File.ReadAllTextAsync(decryptedContentFilePath1);
        ...
        public async Task DecryptFileAndVerifyAsync_DecryptSignedAndEncryptedFileDifferentKeys(KeyType keyType)
        {
            ...
            await pgp.DecryptFileAndVerifyAsync(encryptedContentFilePath, decryptedContentFilePath1, publicKeyFilePath1, privateKeyFilePath2, password2);
            string decryptedContent = await File.ReadAllTextAsync(decryptedContentFilePath1);
        ...
        public async Task VerifyAsync_VerifySignedFile(KeyType keyType)
        {
            ...
            // Act
            await pgp.SignFileAsync(contentFilePath, signedContentFilePath, privateKeyFilePath1, password1);
            bool verified = await pgp.VerifyFileAsync(signedContentFilePath, publicKeyFilePath1);
        ...
        private async Task ArrangeAsync(KeyType keyType, FileType fileType = FileType.Known)
        {
            Directory.CreateDirectory(keyDirectory);
            ...
            {
                await pgp.GenerateKeyAsync(publicKeyFilePath1, privateKeyFilePath1, userName1, password1);
                await pgp.GenerateKeyAsync(publicKeyFilePath2, privateKeyFilePath2, userName2, password2);
            }
