...
namespace PgpCore.Tests.UnitTests.GenerateKey
{
    public class KeySync : TestBase
    {
        ...
        [Theory]
        [InlineData(PublicKeyAlgorithmTag.RsaGeneral)]
        [InlineData(PublicKeyAlgorithmTag.ElGamalGeneral)]
        public void GenerateKey_CreatePublicAndPrivateKeysWithDifferentPublicKeyAlgorithms_ShouldCreateKeysWithSpecifiedAlgorithms(PublicKeyAlgorithmTag publicKeyAlgorithm)
        {
            // Arrange
            TestFactory testFactory = new TestFactory();
            testFactory.Arrange();
