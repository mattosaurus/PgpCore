...
- [Usage](#usage)
- [Azure Function Example](#azure-function-example)
	- [Methods](#methods)
	- [Settings](#settings)
		...
		- [Verify and Read Clear](#verify-and-read-clear)
			- [VerifyAndReadClearFileAsync](#verifyandreadclearfileasync)
	...
	- [Settings](#settings-1)
		...
		- [PgpSignatureType](#pgpsignaturetype)
